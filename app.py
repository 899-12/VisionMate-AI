...
GEMINI_API_KEY = get_api_key_from_file("C:/Users/aarsh/OneDrive/Desktop/AI Assistant/gemini_api_key.txt")  
...
st.sidebar.title("🛠️ VisionMate Features")
st.sidebar.markdown("""
Welcome to **VisionMate**! Select a service below to assist you with various tasks:

- **🖼️ Scene Understanding**: Understand the content of images.
...
Feel free to explore the services to help enhance your experience.
""")
...
scene_button = col1.button("🖼️ Scene Description")
